...
CREATE TABLE `aluno_disciplina` (
  ...
  `data` date NOT NULL,
  `status` enum('CONCLUIDO','CANCELADO','PENDENTE') DEFAULT NULL,
  `media_atual` decimal(3,1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `aluno_id` (`aluno_id`),
  KEY `disciplina_id` (`disciplina_id`),
  CONSTRAINT `aluno_disciplina_ibfk_1` FOREIGN KEY (`aluno_id`) REFERENCES `aluno` (`id`),
  CONSTRAINT `aluno_disciplina_ibfk_2` FOREIGN KEY (`disciplina_id`) REFERENCES `disciplina` (`id`)
...
INSERT INTO `aluno_disciplina` VALUES (1,1,2,'2026-04-15','CONCLUIDO',5.5),(2,2,1,'2026-04-15','PENDENTE',7.5);
